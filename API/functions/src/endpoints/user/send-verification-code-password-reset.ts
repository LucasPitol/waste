...
export const sendVerificationCodeForPasswordReset = functions.https.onRequest(async (req, res) => {
  try {
    ...
    console.error("Send verification code for password reset error:", error);
