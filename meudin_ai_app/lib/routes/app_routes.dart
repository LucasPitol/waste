...
import 'package:meudin_ai_app/pages/plans/plans_page.dart';
...
import 'package:meudin_ai_app/pages/contact_support/contact_support_page.dart';
...
class AppRoutes {
  ...
  static String contactSupportRoute = '/contact-support';
