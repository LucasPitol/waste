    ...
    if (response.success) {
      ...
      Future.microtask(() {
        Get.bottomSheet(
          JoyModal.errorBottomSheet(
            context: Get.context!,
            errorList: [response.errorMessage ?? 'Erro ao atualizar transação'],
    ...
    try {
      ...
      if (response.success) {
        ...
        Get.bottomSheet(
          JoyModal.errorBottomSheet(
            context: Get.context!,
            errorList: [response.errorMessage ?? 'Erro ao excluir receita'],
      ...
      Get.bottomSheet(
        JoyModal.errorBottomSheet(
          context: Get.context!,
          errorList: ['Erro inesperado ao excluir receita'],
          title: 'Erro ao excluir receita',
        ),
        isScrollControlled: true,
        shape: const RoundedRectangleBorder(
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      deleteRevenue(); // Execute deletion
                    },
